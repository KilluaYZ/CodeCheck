...
def execute_sql_query_by_property(pooldb ,table: str, key: str, val: str):
    return execute_sql_query(pooldb, f'select * from {table} where {key}=%s',(val))

def execute_sql_query_by_property_unique(pooldb ,table: str, key: str, val: str):
    return execute_sql_query_one(pooldb, f'select * from {table} where {key}=%s',(val))
